        ...
        <div class="col-md-6">
            ...
            <div class="mb-3">
                ...
                <div id="hide_kustom_css">
                    <textarea name="custom_css" rows="7" class="form-control" id="custom_css"></textarea>
                </div>
            </div>
            <div class="mb-3">
                ...
                <div id="hide_script_locker">
                    <textarea name="script_locker" rows="7" class="form-control" id="script_locker"></textarea>
                </div>
            </div>
        </div>
        <div class="col-md-6">
